...
| 04 与软通动力的合作切入点 | 3 个具体合作建议，含推荐理由、合作方式和优先级 |
...
- 结合内置的软通动力能力模型（`knowledge/softcom_profile.md`）生成合作建议
...
| **软通视角** | 无行业洞察，泛泛建议 | **内置软通动力能力模型**，合作建议与软通实际能力精准匹配 |
